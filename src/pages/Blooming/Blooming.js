...
const BlossomingFlowers = () => {
    ...
    useEffect(() => {
        ...
        flowers.forEach((flower) => flower.classList.add("bloom"));

        return () => {
            flowers.forEach((flower) => flower.classList.remove("bloom"));
        };
    }, []); 

    return (
        <div className="BlomingBody">
            <audio ref={audioRef} src="assets/audio/flowers2.mp3" loop></audio>
